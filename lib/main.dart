...
import 'package:flutter_study/mvvm/routes/app_pages.dart';
import 'package:flutter_study/mvvm/routes/app_routes.dart';
import 'package:flutter_study/mvvm/themes/app_theme.dart';
    ...
    return ScreenUtilInit(
      builder: (BuildContext context, Widget? child) {
        return GetMaterialApp(
          //GetX自带的MaterialApp，配置路由表，管理路由入栈、出栈等操作
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const MyHomePage(title: 'Flutter Demkkggo Home Page'),
    );
  }
}
